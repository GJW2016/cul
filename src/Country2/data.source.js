...
export const Pricing00DataSource = {
  ...
  img: {
    ...
    name: 'image',
    children:
      'https://www.culturallydiversity.tk/images/dragon.jpg',
  },
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <>
            <p><font size='3'>Dragon boat Festival: One festival to memorize a famous poet- Qu Yuan, who is also a
              Patriot. People would like to eat rice pudding in this day.</font>
</p>
          </>
        ),
